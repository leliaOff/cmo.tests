<template>
    <div>
        ...
        <!-- Минимум -->
        <div class="row">
            <div class="col-sm-3 clearfix"><label class="input-title">Минимальное значение:</label></div>
            <div class="col-sm-9 clearfix"><input type="number" class="form-control" step="0.1" :max="setting.max" placeholder="3" v-model="setting.min" /></div>
        </div>

        <!-- Максимум -->
        <div class="row">
            <div class="col-sm-3 clearfix"><label class="input-title">Максимальное значение:</label></div>
            <div class="col-sm-9 clearfix"><input type="number" class="form-control" step="0.1" :min="setting.min" placeholder="18" v-model="setting.max" /></div>
        </div>
