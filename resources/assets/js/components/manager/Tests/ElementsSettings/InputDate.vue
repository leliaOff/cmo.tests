<template>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 clearfix"><datepicker v-model="setting.min" format="dd.MM.yyyy" :first-day-of-week="1" lang="ru" ></datepicker></div>
        </div>

        <!-- Максимум -->
        <div class="row">
            <div class="col-sm-3 clearfix"><label class="input-title">Максимальное значение:</label></div>
            <div class="col-sm-9 clearfix"><datepicker v-model="setting.max" format="dd.MM.yyyy" :first-day-of-week="1" lang="ru" ></datepicker></div>
        </div>
